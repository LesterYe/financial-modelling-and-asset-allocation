...
plot(muP,wts.new[,2],type='l',lty=3, xlim=c(0,0.02), main='UUP')
lines(muP.test,wts.test[,2],type='l',col='red')
plot(muP,wts.new[,3],type='l',lty=3, xlim=c(0,0.02), main='FXE')
lines(muP.test,wts.test[,3],type='l',col='red')
plot(muP,wts.new[,4],type='l',lty=3, xlim=c(0,0.02), main='FXNAX')
lines(muP.test,wts.test[,4],type='l',col='red')
plot(muP,wts.new[,5],type='l',lty=3, xlim=c(0,0.02), main='FXY')
lines(muP.test,wts.test[,4],type='l',col='red')
plot(muP,wts.new[,6],type='l',lty=3, xlim=c(0,0.02), main='SEGA.MI')
